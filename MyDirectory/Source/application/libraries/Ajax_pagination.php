...
class Ajax_pagination{
   ...
   var $category='';
      ...
      if ($this->show_count)
      {
		...
		if  ($this->cur_page > $this->num_links)
		{
			$output .= $this->first_tag_open 
					. $this->getAJAXlink( '' , $this->first_link,$this->city1,$this->category)
		...
		if  ($this->cur_page != 1)
		{
			...
			$output .= $this->prev_tag_open 
					. $this->getAJAXlink( $i, $this->prev_link,$this->city1,$this->category)
					. $this->prev_tag_close;
		}
			...
			if ($i >= 0)
			{
				...
				else
				{
					...
					$output .= $this->num_tag_open
						. $this->getAJAXlink( $n, $loop,$this->city1,$this->category )
						. $this->num_tag_close;
				}
			}
		}
		...
		if ($this->cur_page < $num_pages)
		{
			$output .= $this->next_tag_open 
				. $this->getAJAXlink( $this->cur_page * $this->per_page , $this->next_link,$this->city1,$this->category)
				. $this->next_tag_close;
		}
		...
		if (($this->cur_page + $this->num_links) < $num_pages)
		{
			...
			$output .= $this->last_tag_open . $this->getAJAXlink( $i, $this->last_link,$this->city1,$this->category ) . $this->last_tag_close;
		}
	...
	function getAJAXlink( $count, $text,$city1,$category) {
        ...
        $this->additional_param = "{'page':$pageCount,'city':'$city1','business':'$category'}";
