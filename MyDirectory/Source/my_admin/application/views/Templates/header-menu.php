            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
				...
				<a href="#" class="dropdown-toggle" data-toggle="dropdown">				          
                  ...
                  <span class="hidden-xs"><?php echo $this->session->userdata('admin_logged_in')['username']?></span>
                </a> 
			<?php
			//var_dump($this->session->userdata('profile_pic'));
			//exit();
			?>
                  ...
                  <!-- Menu Footer-->
                   <li class="user-footer">
                    <div class="pull-left">
				            <?php
					$profile_link = ($this->session->userdata('admin') == 1) ? base_url()."Admin_profiledetails/view_Admin_profile" : base_url()."Profile_details/view_profile";
