          ...
          <div class="row">
			...
			?>
              ...
              <div class="box box-warning">
                ...
                <!-- form start -->
                <form role="form" action="<?php echo base_url();?>Profile_details/view_profile" method="post" data-parsley-validate="" class="validate" enctype="multipart/form-data">
              ...
              <div class="box box-warning">
                ...
                <!-- form start -->
                <form role="form" action="<?php echo base_url(); ?>Profile_details/change_password" method="post"  data-parsley-validate="" class="validate" enctype="multipart/form-data">
