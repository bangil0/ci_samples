<div class="content-wrapper">
	...
	<div class="col-md-7">
                ...
                <!-- form start -->
				 ...
				 <div class="box-body box-profile">
                  ...
                  <div class="user-profile-pic">
                     <img class="profile-user-img img-responsive img-circle" src="<?php echo  $data->profile_picture; ?>" alt="User profile picture">
              ...
              <div class="box box-warning">
                ...
                <!-- form start -->
                <form role="form" action="<?php echo base_url(); ?>Admin_profiledetails/change_admin_password" method="post" data-parsley-validate="" class="validate" enctype="multipart/form-data">
