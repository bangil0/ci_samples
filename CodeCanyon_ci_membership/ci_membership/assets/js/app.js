...
!function ($) {
    ...
    $(function() {
        ...
        // Parsley OAuth2 resend activation form
        ...
        // --> Adminpanel
        // Parsley site settings
        var $adminpanelSettingForm = $("#settings_form");
        if ($adminpanelSettingForm.length) {
            parsleyFactory( $adminpanelSettingForm, $("#settings_form_submit") );
        }

        // Parsley add member
        var $adminpanelAddMemberForm = $("#add_member_form");
        if ($adminpanelAddMemberForm.length) {
            parsleyFactory( $adminpanelAddMemberForm, $("#add_member_submit") );
        }
        ...
        if ($('#fileupload').length) {
            var url = CI.base_url + 'membership/profile/upload_profile_picture';
