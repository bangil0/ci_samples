        ...
        <div id="regular_wrapper">
            ...
            <div class="form-group">
                <input type="text" name="username" id="username" class="form-control input-lg"
                       ...
                       required>
                <p class="small pd-5">
                    <strong><?php print $this->lang->line('register_req_username'); ?>
                </p>
            </div>
            ...
            <div class="form-group">
                ...
                <p class="small pd-5">
                    <strong><?php print $this->lang->line('register_req_password'); ?>
                </p>
            </div>

            <div class="form-group">
                <input type="password" name="password_confirm" id="password_confirm" class="form-control input-lg"
                       placeholder="<?php print $this->lang->line('password_confirm'); ?>"
                       value="<?php print $this->session->flashdata('password_confirm'); ?>"
                       data-parsley-equalto="#password"
                       required>
                <p class="small pd-5">
                    <strong><?php print $this->lang->line('register_req_password_2'); ?>
                </p>
            </div>
            ...
            <div class="form-group">
                <button type="submit" name="register_submit" id="register_submit" class="btn btn-primary btn-lg js-btn-loading" data-loading-text="Registering...">
                    <i class="fa fa-check pd-r-5"></i> <?php print $this->lang->line('account_create'); ?>
                </button>
            </div>
