...
<div class="text-center">
    <h1 class="fg-primary f900 text-uppercase">CI Membership <?php print CIM_VERSION; ?></h1>
...
<div class="container text-center">
    ...
    <div class="row">
        <div class="col-sm-6">
            <a href="http://codeigniter.com"><img src="<?php print base_url(); ?>assets/img/manual/codeigniter-logo-sm.png" alt=""></a>
        </div>
        <div class="col-sm-6">
            <a href="http://getbootstrap.com"><img src="<?php print base_url(); ?>assets/img/manual/bootstrap3-sm.png" alt=""></a>
        </div>
    </div>
    ...
    <p>There's already 72 tickets for the next version(s).</p>
