...
<div class="row">
    <div class="col-sm-6">
        <?php print form_open('adminpanel/member_detail/save', 'autocomplete="off"') ."\r\n"; ?>
...
<div>
    ...
    <div class="form-group">
        <button type="submit" class="btn btn-primary btn-lg js-btn-loading" data-loading-text="Updating..."><i class="fa fa-check pd-r-5"></i> <?php print $this->lang->line('member_detail_save'); ?></button>
