...
<?php $this->load->view('themes/'. Settings_model::$db_config['adminpanel_theme'] .'/partials/content_head.php'); ?>
    ...
    <p>
        <button type="submit" name="site_settings_submit_top" id="settings_form_submit" class="btn btn-primary btn-lg js-btn-loading" data-loading-text="Saving...">
		...
		<div class="row">
			<div class="col-lg-4 col-md-4 col-sm-4 clearfix">
				<input type="text" name="admin_email" id="admin_email" class="form-control"
                       value="<?php print Settings_model::$db_config['admin_email_address']; ?>"
