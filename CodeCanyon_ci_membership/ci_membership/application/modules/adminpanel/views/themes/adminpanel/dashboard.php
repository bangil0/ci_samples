    ...
    <div class="panel-body bg-white">
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <tr>
                    <th>id</th>
                    <th><?php print $this->lang->line('username'); ?></th>
                    <th><?php print $this->lang->line('first_name'); ?></th>
                    <th><?php print $this->lang->line('last_name'); ?></th>
                    <th><?php print $this->lang->line('email_address'); ?></th>
                </tr>
                </thead>
                <tbody>
