...
<div class="row">
    <div class="col-sm-4">
        ...
        <?php print form_open('membership/profile/upload_profile_picture', array('id' => 'upload_profile_picture')) ."\r\n"; ?>
        ...
        <?php }else{ ?>
            <div class="mg-t-10">
                <img id="js_profile_image" src="<?php print base_url(); ?>assets/img/members/members_generic.png" class="profile-img img-thumbnail">
            </div>
        <?php } ?>
...
<div class="row">
	...
	<?php print form_open('membership/profile/update_account', array('id' => 'profile_form')) ."\r\n"; ?>
...
<?php print form_open('membership/profile/update_password', array('id' => 'profile_pwd_form')) ."\r\n"; ?>
